...
class PinnacleLogin(PinnacleMember):
    ...
    def __newmember(self):
        ...
        postData = {'__EVENTTARGET':'',
                    ...
                    'ctl00$PCPH$AL1DDL':self.id_first,
                    ...
                    'ctl00$PCPH$SSPTDL$ctl19$LiveCopyFromDeadbHidden':'false',
                    'ctl00$PCPH$SSPTDL$ctl20$SSSportSubTypeH':'.',
                    'ctl00$PCPH$SSPTDL$ctl20$SSPT2TB':'',
                    'ctl00$PCPH$SSPTDL$ctl20$SSPT4TB':'',
                    'ctl00$PCPH$SSPTDL$ctl20$SSPT6TB':'',
                    ...
                    'ctl00$PCPH$SSPTDL$ctl21$LiveCopyFromDeadbHidden':'false',
                    'ctl00$PCPH$SSPTDL$ctl22$SSPTH2H':'Baseball',
                    'ctl00$PCPH$SSPTDL$ctl22$SSSportSubTypeH':'MLB',
                    'ctl00$PCPH$SSPTDL$ctl22$SSPT2TB':'',
                    'ctl00$PCPH$SSPTDL$ctl22$SSPT4TB':'',
                    'ctl00$PCPH$SSPTDL$ctl22$SSPT6TB':'',
                    ...
                    'ctl00$PCPH$SSPTDL$ctl23$LiveCopyFromDeadbHidden':'false',
                    'ctl00$PCPH$SSPTDL$ctl24$SSSportSubTypeH':'.',
                    'ctl00$PCPH$SSPTDL$ctl24$SSPT2TB':'',
                    'ctl00$PCPH$SSPTDL$ctl24$SSPT4TB':'',
                    'ctl00$PCPH$SSPTDL$ctl24$SSPT6TB':'',
                    ...
                    'ctl00$PCPH$SSPTDL$ctl25$LiveCopyFromDeadbHidden':'false',
                    'ctl00$PCPH$SSPTDL$ctl26$SSPTH2H':'Hockey',
                    'ctl00$PCPH$SSPTDL$ctl26$SSSportSubTypeH':'NHL OT Incl',
                    'ctl00$PCPH$SSPTDL$ctl26$SSPT2TB':'',
                    'ctl00$PCPH$SSPTDL$ctl26$SSPT4TB':'',
                    'ctl00$PCPH$SSPTDL$ctl26$SSPT6TB':'',
                    ...
                    'ctl00$PCPH$SSPTDL$ctl27$LiveCopyFromDeadbHidden':'false',
                    'ctl00$PCPH$SSPTDL$ctl28$SSSportSubTypeH':'NHL Reg Time',
                    ...
                    'ctl00$PCPH$SSPTDL$ctl29$SSSportSubTypeH':'.',
                    'ctl00$PCPH$SSPTDL$ctl29$SSPT2TB':'',
                    'ctl00$PCPH$SSPTDL$ctl29$SSPT4TB':'',
                    'ctl00$PCPH$SSPTDL$ctl29$SSPT6TB':'',
                    ...
                    'ctl00$PCPH$SSPTDL$ctl30$LiveCopyFromDeadbHidden':'false',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPTH2H':'All Other Sports',
                    'ctl00$PCPH$SSPTDL$ctl31$SSSportSubTypeH':'.',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT2TB':'',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT4TB':'',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT6TB':'',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT14DDL$HoldDropDownList':'0.00',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT15DDL':'0.00',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT18DDL':'0.00',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPT19DDL':'0.00',
                    'ctl00$PCPH$SSPTDL$ctl31$SSPTC3HF':'false',
                    'ctl00$PCPH$SIPT2TB':'',
                    'ctl00$PCPH$SIPT4TB':'',
    ...
    def login(self):
        ...
        self.__getcaptcha()
        self.__newmember()
        self.__resetpassword()# reset the password
...
if __name__ == '__main__':
    ...
    userlogin.setMemberName('Test','Test')#set the firstname and lastname
    userlogin.setMemberNewPassowrd('')#set the new password
    userlogin.setCreditLimit(0) #set the credit limit
    for i in range(0,3):
        userlogin.setMemberId('A',0,i)#set the last three numbers or alphabets of the memberID
        userlogin.login()
